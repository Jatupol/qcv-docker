...
class ReportService extends BaseService {
   ...
   */
  async getOverviewOQALotDetail(fy: string, ww: string, partno_customer: string, defect_group: string): Promise<ApiResponse<{ lotno: string; ng_qty: number }[]>> {
    const params = new URLSearchParams({ fy, ww, partno_customer, defect_group });
   ...
   */
  async getModelsSGAIQA(params?: { year?: string; ww?: string }): Promise<ApiResponse<string[]>> {
...
export const getModelsSGAIQA = (params?: { year?: string; ww?: string }) => reportService.getModelsSGAIQA(params);
...
export const getOverviewOQALotDetail = (fy: string, ww: string, partno_customer: string, defect_group: string) => reportService.getOverviewOQALotDetail(fy, ww, partno_customer, defect_group);
