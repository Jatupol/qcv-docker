// ===================================
// client/src/components/common/NotificationSystem.tsx
// Simplified notification system to avoid circular dependencies
  ...
  return (
    ...
    >
      <div className="flex items-start">
        ...
        <button
          onClick={onClose}
          className="flex-shrink-0 ml-3 text-lg opacity-60 hover:opacity-100 transition-opacity duration-200"
        >
