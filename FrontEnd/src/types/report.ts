 ...
 */
export type GroupByDimension = 'production_site' | 'customer_site' | 'product_family' | 'product_type' | 'model';
export type TimePeriod = 'daily' | 'fiscal_weekly' | 'monthly' | 'quarterly' | 'yearly';
