...
const InspectionCustomerEditPage = lazy(() => import('./pages/customer-data/InspectionCustomerEditPage'));
...
const routeGroups: RouteGroup[] = [
    ...
    // Customer Data Routes
  {
    ...
    routes: [
      ...
      { path: '/customer-data/oqa/new', element: InspectionCustomerEditPage, requiredRoles: ['user', 'manager', 'admin','viewer'] },
