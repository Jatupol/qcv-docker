...
const PartsPage: React.FC = () => {
  ...
  const missingItemsBanner = missingItemsLoaded && missingItems.length > 0 ? (
      ...
      <div className="flex items-start gap-3 bg-amber-50 border-2 border-amber-400 rounded-xl px-4 py-3 shadow-md">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-bold text-amber-800 text-sm mb-1">
            พบรายการ Item ที่ยังไม่มีใน Master Parts ({missingItems.length} รายการ) — กรุณาเพิ่มข้อมูลต่อไปนี้:
          </p>
  ...
  return (
    <>
      <SpecialEntityCodePage<Parts>
        ...
        afterSearchContent={missingItemsBanner}
      />
