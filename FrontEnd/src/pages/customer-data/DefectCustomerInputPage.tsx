...
const DefectCustomerInputPage: React.FC = () => {
  ...
  const inspectionNoFromUrl = searchParams.get('inspection_no') || '';
...
const createDefectInputValidationSchema = (isSIVStation: boolean): ValidationSchema<typeof formData> => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-purple-100">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-violet-700 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-white">Defect Input (Customer Format)</h1>
                <p className="text-sm text-purple-200">Record and track defect inspection data</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        {/* SECTION 2: Defect Input Form - Purple Theme */}
        <div className="bg-gradient-to-r from-purple-500 to-violet-600 rounded-2xl shadow-2xl border-2 border-purple-400 p-6 transform transition-all hover:scale-[1.01]">
        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl shadow-2xl border-2 border-green-400 p-6 transform transition-all hover:scale-[1.01]">
          ...
          <div className="bg-white rounded-xl overflow-hidden">
            <div className="p-6">
              <DefectsDataTable
                key={tableRefreshKey}
                inspectionNo={inspectionData?.inspection_no || inspectionNoFromUrl}
                showHeader={false}
                showStatistics={true}
                showDelete={true}
