    ...
    >
      ...
      <Section title="การเข้าถึงหน้า OQA Inspection">
        ...
        <div style={{ marginBottom: '20px', textAlign: 'center' }}>
          ...
          />
          <p style={{ marginTop: '10px', fontSize: '14px', color: '#666', fontStyle: 'italic' }}>
            ภาพที่ 2: หน้า จอสำหรับบันทึกการตรวจสอบ OQA Steps 1 - 2
          </p>
        </div>
        <div style={{ marginBottom: '20px', textAlign: 'center' }}>
          <img
          ...
          />
          <p style={{ marginTop: '10px', fontSize: '14px', color: '#666', fontStyle: 'italic' }}>
            ภาพที่ 3: หน้า จอสำหรับบันทึกการตรวจสอบ OQA Steps 3 - 4
          </p>
        </div>                
      </Section>
      ...
      <Section title="หลังจากบันทึกการตรวจสอบ">
        ...
        <div style={{ background: '#e3f2fd', padding: '15px', borderRadius: '8px', marginBottom: '15px', border: '1px solid #90caf9' }}>
          <p style={{ margin: '0 0 10px 0', fontWeight: 'bold', color: '#1565c0', fontSize: '16px' }}>
            📋 เงื่อนไขการสร้าง SIV:
          </p>
          <ul style={{ margin: 0, paddingLeft: '20px', color: '#0d47a1' }}>
            <li><strong>เฉพาะ OQA เท่านั้น</strong> ที่สามารถสร้าง SIV ได้ (OBA และ Station อื่นไม่สามารถสร้างได้)</li>
            <li>ผลการตรวจสอบต้องเป็น <strong>"Pass"</strong> เท่านั้น (Reject ไม่สามารถสร้าง SIV ได้)</li>
            <li>Part Number ต้อง<strong>ไม่ใช่</strong> SGT Customer Part (ชิ้นส่วนของลูกค้า SGT จะถูกข้ามอัตโนมัติ)</li>
          </ul>
        </div>

        <div style={{ background: '#fff3cd', padding: '15px', borderRadius: '8px', marginBottom: '15px', border: '1px solid #ffc107' }}>
          <p style={{ margin: '0 0 10px 0', fontWeight: 'bold', color: '#856404', fontSize: '16px' }}>
            💡 การสร้าง SIV จากหน้า Inspection List:
          </p>
          <ul style={{ margin: 0, paddingLeft: '20px', color: '#664d03' }}>
            <li>สามารถสร้าง SIV ได้ภายหลังจากหน้า OQA Sampling Lists โดยคลิกปุ่ม "Generate SIV" ที่แถวรายการ</li>
            <li>ปุ่ม "Generate SIV" จะแสดงเฉพาะรายการ OQA ที่ Pass และไม่ใช่ SGT Part เท่านั้น</li>
          </ul>
        </div>
