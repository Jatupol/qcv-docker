...
const colorStyles = {
  ...
  emerald:{ focus: 'focus:ring-emerald-400 focus:border-emerald-400', check: 'text-emerald-500 focus:ring-emerald-400', hover: 'hover:bg-emerald-50', border: 'border-emerald-300', badge: 'bg-emerald-100 text-emerald-700' },
};
