 ...
 */
export function getFiscalYearStartDate(fiscalYear, fiscalYearStartDay = 6) {
 ...
 */
export function calculateFiscalWeekNumber(date, fiscalYearStartDay = 6) {
 ...
 */
export function getFiscalYear(date, fiscalYearStartDay = 6) {
    const targetDate = typeof date === 'string' ? new Date(date) : new Date(date);
 ...
 */
export function getFiscalWeekRange(fiscalYear, weekNumber, fiscalYearStartDay = 6) {
 ...
 */
export function formatFiscalWeek(date, format = 'YYYY-WW', fiscalYearStartDay = 6) {
    const targetDate = typeof date === 'string' ? new Date(date) : new Date(date);
    const fiscalYear = getFiscalYear(targetDate, fiscalYearStartDay);
 ...
 */
export function getCurrentFiscalWeek(fiscalYearStartDay = 6) {
 ...
 */
export function getCurrentFiscalYear(fiscalYearStartDay = 6) {
 ...
 */
export function getPreviousFiscalWeek(fiscalYearStartDay = 6) {
 ...
 */
export function getMonthTrendName(yearmonthtrend = '') {
 ...
 */
export function fiscalWeekToYearMonth(fiscalYearWeek, fiscalYearStartDay = 6) {
