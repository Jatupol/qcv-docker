...
class DefectImageService {
    ...
    async update(id, imageData, userId) {
        try {
            ...
            console.error('Error updating defect image:', error);
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Failed to update defect image'
            };
        }
    }
    ...
    async getAll(userId) {
        try {
            ...
            return {
                success: true,
                data: images,
                message: `Retrieved ${images.length} defect images`
            };
        }
        catch (error) {
            console.error('Error getting all defect images:', error);
            return {
                success: false,
                error: error instanceof Error ? error.message : 'Failed to get defect images'
            };
