...
exports.defectCustomerImage = void 0;
const pg_core_1 = require("drizzle-orm/pg-core");
const common_1 = require("./common");
exports.defectCustomerImage = (0, pg_core_1.pgTable)('defect_customer_image', {
    ...
    photoMagnification: (0, pg_core_1.varchar)('photo_magnification', { length: 20 }),
