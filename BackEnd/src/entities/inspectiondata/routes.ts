...
export class InspectionDataRoutes {
  ...
  private initializeRoutes(): void {
     ...
     */
    this.router.get('/customerdata-judgment/:inspectionNo',
      requireAuthentication,
      requireUser,
      (req: Request, res: Response, next: NextFunction) => {
        this.controller.getCustomerJudgment(req as any, res, next);
      }
    );
     ...
     */
    this.router.put('/customerdata-judgment',
      requireAuthentication,
      requireUser,
      (req: Request, res: Response, next: NextFunction) => {
        this.controller.updateCustomerJudgment(req as any, res, next);
      }
    );
